...
- Weapon и Ability используют общий `ActionContext`, который переносит Check, цели и признаки действия по производной цепочке.
- Конструктор защит предлагает все подходящие варианты: Самозащиту, Противодействие, Уворот и специальные защитные Ability; выбор остаётся за пользователем.
